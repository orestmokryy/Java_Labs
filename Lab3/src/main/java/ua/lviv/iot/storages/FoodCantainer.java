...
public class FoodCantainer extends AbstractCappedStorage {
	...
	public FoodCantainer(double capacityInLiters, double priceInUAH, double weightInKilograms, String productionCountry,
